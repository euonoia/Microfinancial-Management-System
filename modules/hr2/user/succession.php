...
$employee_company_id = $_SESSION['employee_id']; // varchar employee_id
...
$stmt->bind_param("s", $employee_company_id); // bind the varchar company employee_id
$stmt->execute();
...
h2 { color: #111827; margin-bottom: 20px; text-align:center; }
